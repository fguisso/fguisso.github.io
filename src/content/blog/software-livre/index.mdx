...
lang: 'pt'
canonicalSlug: 'software-livre-potilivre'
...
pubDate: 2026-06-16T10:00:00-03:00
showDate: true
showTableOfContents: true
tags: ["software livre", "comunidade", "soberania digital", "licenças"]
---
...
import swartz from './swartz.jpg';
import reprap from './reprap.jpg';
...
Este artigo nasceu de uma palestra que dei sobre o tema. Os **[slides estão publicados aqui](https://guisso.dev/talks/software-livre/)**. O conteúdo, os slides e este texto estão sob `CC BY-SA 4.0`, no mesmo espírito da PotiLivre.
...
<Timeline items={[
  { meta: "2004", role: "Fundação do PSL-RN · artigo 'GPL sem medo'" },
  { meta: "2005", role: "1º FLISoL no RN · I Encontro Potiguar (I EPSL)" },
  { meta: "2006", role: "I Encontro Nordestino (ENSL) · colabora no FISL" },
  { meta: "2007", role: "II ENSL (Aracaju) · III EPSL" },
  { meta: "2009 – 2011", role: "III, IV e V ENSL (Salvador, Natal, Maceió)" },
  { meta: "2014", role: "Encerramento do PSL-RN" },
]} />
...
<Callout title="Comunidade livre não é automaticamente comunidade justa" variant="warning">
...
|-----------|----------|:--------:|:-----------:|
| **Permissivas** (use, feche, faça o que quiser, só mantenha o crédito) | <Chip>MIT</Chip> <Chip>BSD</Chip> <Chip>Apache 2.0</Chip> | não | não |
| **Copyleft fraco / por arquivo** (só o arquivo modificado segue livre) | <Chip>LGPLv3</Chip> <Chip>MPL 2.0</Chip> | fraco | não |
| **Copyleft forte** (todo derivado redistribuído também é livre) | <Chip>GPLv2</Chip> <Chip>GPLv3</Chip> | forte | não |
| **Copyleft + rede** (abre o código mesmo rodando como serviço) | <Chip variant="solid">AGPLv3</Chip> | forte | **sim** |
...
<Callout title="Domínio público ≠ software livre" variant="info">
...
Licença não é só ideologia. Um mesmo projeto pode ter objetivos diferentes e, por isso, **licenças diferentes**. É o caso do meu projeto [gapes](https://github.com/fguisso/gapes):
...
<Callout title="A comunidade venceu" variant="success">
...
<Image src={swartz} alt="Aaron Swartz" width={520} style="border-radius:12px;filter:grayscale(1)" />

<p style="font-size:0.85rem;opacity:0.7;margin-top:-0.5rem">Aaron Swartz · CC BY-SA, Wikimedia Commons</p>
...
<Timeline items={[
  { meta: "1988", role: "Scott Crump patenteia o FDM e funda a Stratasys" },
  { meta: "1991", role: "Primeiras FDM comerciais: dezenas de milhares de dólares" },
  { meta: "2005", role: "Adrian Bowyer cria o RepRap, impressora 3D open source (GPL) que imprime as próprias peças" },
  { meta: "2009", role: "A patente FDM expira: o ponto de virada" },
  { meta: "2009+", role: "MakerBot, Ultimaker, Prusa: o preço cai cerca de 100×" },
]} />

<Image src={reprap} alt="RepRap Mendel" width={420} style="border-radius:12px;filter:grayscale(1)" />

<p style="font-size:0.85rem;opacity:0.7;margin-top:-0.5rem">RepRap "Mendel" · Wikimedia Commons</p>
...
<Callout title="Hardware livre não é hobby" variant="info">
...
<p style="font-size:0.85rem;opacity:0.7">Conteúdo com base em fontes públicas e em pesquisa de junho/2026. Licença deste artigo: <strong>CC BY-SA 4.0</strong>.</p>
