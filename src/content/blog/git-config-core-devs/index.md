---
title: "Config Git dos Core Devs"
lang: 'pt'
canonicalSlug: 'git-config-core-devs'
description: "Uma analise das configuracoes recomendadas pelo time core do Git."
pubDate: 2025-02-26T10:42:45-03:00
tags: ["git", "devtools"]
---

> Nota: Este post e uma traducao livre de [How Core Git Developers Configure Git](https://blog.gitbutler.com/how-git-core-devs-configure-git/) do autor [Scott Chacon](https://github.com/schacon).
...
> Nota: O Git sempre teve a estrategia `diff3`. Recomendo `zdiff3`, que significa "*zealous diff3*" e e um pouco melhor, mas esta disponivel apenas a partir do Git 2.35 (jan de 2022). Se voce estiver usando uma versao mais antiga do Git, remova o "z".
...
> Nota: Isso executa um processo *por repositorio* em que voce estiver ativo. Em geral, esses processos sao baseados em eventos e nao devem afetar significativamente a memoria ou a CPU, mas e algo a considerar. Voce tambem pode omitir o `--global` e habilitar apenas para repositorios maiores.
